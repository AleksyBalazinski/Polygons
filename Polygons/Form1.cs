...
namespace Polygons
{
    partial class Form1 : Form
    {
        ...
        private void radioButtonXW_CheckedChanged(object sender, EventArgs e)
        {
            if (radioButtonXW.Checked == true)
                drawingAlgorithm.SegmentDrawingAlgorithm = DrawingAlgorithms.LineXiaolinWu;
            Canvas.Invalidate();
        }
